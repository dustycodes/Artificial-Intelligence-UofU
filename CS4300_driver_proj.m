function [x_trace,a_trace,z_trace,Sigma2_trace] = ...
    CS4300_driver_proj(x0,y0,vx0,vy0,max_time,del_t,theta)
% CS4300_driver_lin - driver function for linear Kalman Filter
% On input:
...
Q = [10 0; 0 10];% noise for sensor/level of trust to sensor
...
R = [.001 0 0 0; 0 .001 0 0; 0 0 0.001 0; 0 0 0 0.001];
