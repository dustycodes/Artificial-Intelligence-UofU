function [S,A,R,P,U,Ut] = CS4300_run_value_iteration_Wumpus(eta, max_iter)
% CS4300_MDP_value_iteration_Wumpus - compute policy using value iteration
% On input:
...
%   [S,A,R,P,U,Ut] = CS4300_run_value_iteration_Wumpus(0.999999,1000)
%
