...
% Call:
%     [s,t] = CS4300_WW3(50,'CS4300_Hybrid_Wumpus_Agent');
% Author:
%     T. Henderson
%     UU
%     Summer 2015
...
M = CS4300_show_trace(trace, 1);
for i = 1:length(M)
    imwrite(M(i).cdata, strcat('/Users/dusty/Documents/MATLAB/a4b-figs/board1/step', int2str(i), '.png')); 
end
...
M = CS4300_show_trace(trace, 1);
for i = 1:length(M)
    imwrite(M(i).cdata, strcat('/Users/dusty/Documents/MATLAB/a4b-figs/board2/step', int2str(i), '.png')); 
end
...
M = CS4300_show_trace(trace, 1);
for i = 1:length(M)
    imwrite(M(i).cdata, strcat('/Users/dusty/Documents/MATLAB/a4b-figs/board3/step', int2str(i), '.png')); 
end
